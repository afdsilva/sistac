<div id="content" class="container-fluid">
    ...
    <div class="container">
	    <div class="row" id="envioCertificado">
	        <div class="highlight">
		        <?php
				...
				echo form_open_multipart('aluno/inserirCertificado/' . $aluno->cpf, $attributes);
					...
					echo form_upload(array('name' => 'fileCertificado', 'id' => 'fileCertificado', 'onChange' => $onChange));
		...
		<div class="row">
			<div class="col-xs-12 col-md-8">
				<?php
				$this->table->set_template(array('table_open' => '<table class="table table-hover">'));
				$this->table->set_heading(array('Cod', 'Descrição'));
				foreach ($certificados as $certificado) {
					...
					$this->table->add_row(array(
						...
						$visualizarCertificado . $removerCertificado
					));
				}
				echo $this->table->generate();
				?>

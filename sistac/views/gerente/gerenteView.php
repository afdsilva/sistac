    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group row col-sm-12" style="padding: 20px">
                ...
                <button class="btn btn-success col-md-2 pull-right">Alterar Status</button>
            </div>
            <div class="row"></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="formEditarAtividade">
                ...
                <input type="hidden" class="form-control" id="pedidoId" value="">
...
<script>
    ...
    function salvar(){
        ...
        $.post('../salvar', 
            ...
            function(data) {
                if(data == 'sucesso'){
                    $('#atividades').jtable('load', {});
                    alert('Registro Alterado com sucesso.');
                    
                }else{
                    alert('Houve um problema no banco. Tente novamente!');
                }
            });

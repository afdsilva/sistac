...
class Aluno extends CI_Controller {
	...
	var $data = array('erro' => '', 'pedido' => '', 'pedidos' => '', 'aluno' => '');
    ...
    function uploadPedido() {
    	...
    	if(! $this->upload->do_upload('uploadPedido')) {
    		...
    		if ($curso) $pedido['nomeCurso'] = $this->cursoModel->getCurso($codCurso)->nome;
